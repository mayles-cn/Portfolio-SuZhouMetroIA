    ...
    : QWidget(parent)
{
    ...
    inputEdit_->setStyleSheet(szmetro::UiStyleService::style(
        QStringLiteral("text_prompt.input"),
    ...
    sendButton_->setStyleSheet(szmetro::UiStyleService::style(
        QStringLiteral("text_prompt.send_button"),
